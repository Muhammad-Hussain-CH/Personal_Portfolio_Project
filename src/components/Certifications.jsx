...
const certifications = [
  ...
  {
    id: 6,
    title: 'Coders Clash Competition 2025',
    issuer: 'Bahria University Computing and Innovative Society (BUCIS)',
    date: '2025 – 2026',
    credentialId: '*** PASTE CREDENTIAL ID HERE ***',
    credentialUrl: '*** PASTE CERTIFICATE LINK HERE ***',
    image: '/certs/CODERS_CLASH.jpg',
    color: '#FBBF24',
    badge: 'Full Stack',
  },
  {
  ...
  },
  {
    ...
    credentialId: '*** PASTE CREDENTIAL ID HERE ***',
    credentialUrl: '*** PASTE CERTIFICATE LINK HERE ***',
    image: '/certs/Technofest_2025.jpg',
    color: '#7C3AED',
    badge: 'Learning',
  },
